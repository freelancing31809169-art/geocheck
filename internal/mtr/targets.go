...
var Catalog = []Target{
	...
	},
	{
		...
		ASN: 32934, Port: 443, ICMPSilent: true, Tags: []string{"social"},
	},
	{
	...
	// legitimately be pinned to DC1. Measuring all five shows what each would
	// cost, and they sit in three regions rather than five: DC1 and DC3 share
	// AS59930, DC2 and DC4 share AS62041, and DC5 is alone on AS62014.
	//
	// The apex telegram.org drops ICMP, so the DC addresses are used directly.
	{
		...
		ASN: 59930, Port: 443, Tags: []string{"default", "telegram", "messaging"},
	},
	{
	...
	},
	{
		...
		ASN: 20940, Port: 443, Tags: []string{"social", "video"},
	},
	{
	...
	},
	{
		...
		ASN: 20940, Port: 443, Tags: []string{"cdn"},
	},
	{
		ID: "fastly", Name: "fastly.com", Host: "www.fastly.com", Net: "Fastly",
		ASN: 54113, Anycast: true, Port: 443, Tags: []string{"cdn"},
	},
	{
	...
	{
		ID: "anthropic", Name: "claude.ai", Host: "claude.ai", Net: "Cloudflare / Anthropic",
		ASN: 13335, Anycast: true, Port: 443, Tags: []string{"ai"},
	},
	{
		ID: "github", Name: "github.com", Host: "github.com", Net: "GitHub / Microsoft",
		ASN: 36459, Port: 443, ICMPSilent: true, Tags: []string{"dev"},
	},
	{
